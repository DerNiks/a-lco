  ...
  return (
    ...
    >
      <div className="container mx-auto flex flex-col items-center">
        <h2 className="w-full flex flex-col md:flex-row items-center md:items-baseline justify-center gap-2 md:gap-6 font-serif text-[#102a3b] mb-20 leading-[1.1] md:leading-none md:whitespace-nowrap text-center">
          <span className="text-6xl md:text-8xl">{t.prefix}</span>
          <span className="text-[#f4690c] italic text-6xl md:text-8xl">
            {t.title}
          </span>
        </h2>
